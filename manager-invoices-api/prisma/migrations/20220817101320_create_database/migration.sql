...
-- CreateIndex
CREATE UNIQUE INDEX "mi_company_preferences_company_id_key" ON "mi_company_preferences"("company_id");
...
-- AddForeignKey
ALTER TABLE "mi_company_preferences" ADD CONSTRAINT "mi_company_preferences_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "mi_companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
